...
| 评测有没有保留失败结果 | [Stage 12 原始聚合](evals/stage12-aggregate-v1.json)、[修复后复验聚合](evals/stage12-post-fix-revalidation-v1.json)、[已知限制](docs/product/limitations.md) | 原 19/24、9 通过与复验 24/24、2 通过均不是成功率或上线门 |
...
3. **修复后首次复验**：[新聚合结果](evals/stage12-post-fix-revalidation-v1.json)记录
   ...
   结果差异归因给单一修复。
4. **发布边界**：复验仍暴露大量来源、必需事实与 outcome 不匹配；`product/0.1.0` 继续
