...
| `state` | `in_progress` |
| 更新时间 | `2026-07-30` |
| 当前产品目标 | Issue #29：以面试官视角统一 GitHub、网站与当前事实文档，缩短求职作品集的理解和核查路径 |
| 当前集成任务 | `codex/readme-live-mode`：统一 live / replay 现行口径，重排 README 证据导航并完成最低成本验证 |
| 复杂度 | R1：公开文案与文档增量，不修改检索、生成、Provider 或公共 API 算法 |
...
| 产品候选 | 展示候选开发中；当前已部署产品版本 `766ba3f`（PR #38 / #40，真实 Provider live），候选基于 `origin/main` 当前 head |
